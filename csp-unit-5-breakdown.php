<?php
    ...
    $csvfile = 'unit-5-assessment-breakdown-p3.csv';
    $period = 'period3';
	...
	foreach($students as $student) {
        if($count != 0) {
            ...
            $pdf->Cell(180, 7, 'AP CSP - DAT Standard Grade Breakdown',0,0,'C');
            $pdf->Ln(10);
            ...
            $pdf->Cell(180, 7, 'This document is a breakdown of your DAT standard grade.',0,0,'C');
            $pdf->Ln(10);
            ...
            $pdf->MultiCell(180, 7, 'In this unit learn how data analysis helps turn raw data into useful information about the world. Learn how to use data visualization to find patterns inside of data sets and learn how this data analysis process is being used in contexts like open data or machine learning to help make decisions or learn more about our world. In the unit project, you\'ll analyze a dataset of your choosing and present your findings.', "LBR", 'L', false);
            $pdf->Ln(10);
        ...
        //Overall Grade Breadown Table
            ...
            $pdf->Cell(36,7,$student[22],1,0,'C',true);
            $pdf->Ln();
