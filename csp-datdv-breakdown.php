<?php
	...
	foreach($students as $student) {
        if($count != 0) {
            ...
            $pdf->Cell(180, 7, 'AP CSP - DAT (DV) Standard Grade Breakdown',0,0,'C');
            $pdf->Ln();
            ...
            $pdf->Cell(180, 7, 'This document is a breakdown of your DAT-DV standard grade.',0,0,'C');
            $pdf->Ln();
            ...
            $pdf->Cell(180, 7, 'DAT-DV Standard Overview:','B',0, 'L', false);
            $pdf->Ln();
            $pdf->SetFont('Arial', '', 12);
            $pdf->MultiCell(180, 7, 'In this unit learn how data analysis helps turn raw data into useful information about the world.', "LBR", 'L', false);
            $pdf->Ln(10);
            ...
            $pdf->Cell(60,7,round($student[15] * 100, 0) . '%',1,0,'C',true);
            $pdf->Ln();
            $pdf->setFillColor(160,160,160);
            ...
            $pdf->Cell(60,7,round($student[17], 2),1,0,'C',true);
            $pdf->Ln(10);
            ...
            $pdf->Cell(60,6,round($student[20] * 100, 0) . '%',1,0,'C');
            ...
            $pdf->Cell(45,7,$student[23],1,0,'C',true);
            $pdf->Ln();
            $pdf->setFillColor(61,133,198);
            $pdf->Cell(135, 7, 'Rounded Overall Weighted Unit Score',1,0,'C', true);
            $pdf->Cell(45,7,$student[24],1,0,'C',true);
            $pdf->Ln();
            ...
            } elseif($student[24] >= 2.5 AND $student[24] <=3.49) {
                $pdf->Cell(45,7,'B',1,0,'C',true);
            } elseif ($student[24] >= 1.5 AND $student[24] <=2.49) {
