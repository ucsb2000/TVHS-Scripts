<?php
    ...
    $csvfile = 'unit-3-assessment-breakdown-p3.csv';
    $period = 'period3';
	...
	foreach($students as $student) {
        if($count != 0) {
            ...
            $pdf->Cell(180, 7, 'AP CSP - CRD Standard Grade Breakdown',0,0,'C');
            $pdf->Ln(10);
            ...
            $pdf->Cell(180, 7, 'This document is a breakdown of your CRD standard grade.',0,0,'C');
            $pdf->Ln(10);
