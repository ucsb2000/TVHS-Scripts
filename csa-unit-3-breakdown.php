<?php
    ...
    $csvfile = 'unit-3-assessment-breakdown-p4.csv';
    $period = 'period4';
	...
	foreach($students as $student) {
        if($count != 0) {
            ...
            $pdf->Cell(180, 7, 'AP CSA - Unit 3 Standard Grade Breakdown',0,0,'C');
            $pdf->Ln(10);
            ...
            $pdf->Cell(180, 7, 'This document is a breakdown of your Unit 3 standard grade.',0,0,'C');
            $pdf->Ln(10);
            ...
            $pdf->Cell(180, 7, 'Unit 3 Standard Overview:','B',0, 'L', false);
            $pdf->Ln();
            $pdf->SetFont('Arial', '', 12);
            $pdf->MultiCell(180, 7, 'This unit introduces students to data structures and algorithms that allow for efficient data processing and analysis. Students explore one-dimensional (1D) arrays to store and manipulate both primitive values and object references, applying control structures like loops and conditionals to traverse arrays and implement algorithms. As they develop algorithms, students identify and implement solutions that satisfy preconditions and postconditions. In addition to core technical skills, the unit introduces ethical considerations in data collections, addressing the impact of biased data on fairness and accuracy. By the end of the unit, students develop the skills to design and implement algorithms that work with 1D arrays while considering both technical and ethical dimensions of software engineering.', "LBR", 'L', false);
            $pdf->Ln(10);
        ...
        //Overall Grade Breadown Table
            ...
            $pdf->Cell(36,6,$student[24],1,0,'C');
            $pdf->Ln();
            ...
            $pdf->Cell(36,7,$student[26],1,0,'C',true);
            $pdf->Ln();
        ...
        //Homework Breakdown Table
            ...
            //Table Data
            $pdf->SetFont('Arial', '',12);
            $pdf->Cell(90,6,$student[21],1,0,'C');
            ...
            $pdf->Cell(90, 7, $student[24],1,0,'C',true);
            $pdf->Ln(15);
