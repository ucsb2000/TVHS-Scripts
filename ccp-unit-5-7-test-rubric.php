<?php
    ...
    $csvfile = 'unit-5-7-assessment-breakdown-p2.csv';
    $period = 'period2';
	...
	foreach($students as $student) {
        if($count != 0) {
            ...
            $pdf->Cell(180, 7, 'CTE Computer Programming - Unit 5-7 Grade Breakdown',0,0,'C');
            $pdf->Ln(10);
            ...
            $pdf->Cell(180, 7, 'This document is a breakdown of your Unit 3-4 standard grade.',0,0,'C');
            $pdf->Ln(10);
        ...
        //Homework Breakdown Table
            ...
            $pdf->Cell(90,6,$student[23],1,0,'C');
            ...
            $pdf->Cell(90, 7, $student[26],1,0,'C',true);
            $pdf->Ln(15);
