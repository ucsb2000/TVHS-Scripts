<?php
    ...
    $csvfile = 'unit-1-java-assessment-breakdown-p2.csv';
    $period = 'period2';
	...
	foreach($students as $student) {
        if($count != 0) {
            ...
            $pdf->Cell(180, 7, 'CTE Computer Programming - Unit 1 Grade Breakdown',0,0,'C');
            $pdf->Ln(10);
            ...
            $pdf->Cell(180, 7, 'This document is a breakdown of your Unit 8-9 standard grade.',0,0,'C');
            $pdf->Ln(10);
        ...
        //Homework Breakdown Table
            ...
            $pdf->Cell(90,6,$student[32],1,0,'C');
