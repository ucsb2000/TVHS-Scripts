<?php
    ...
    $csvfile = 'unit-2-assessment-breakdown-p2.csv';
    $period = 'period2';
	...
	foreach($students as $student) {
        if($count != 0) {
            ...
            $pdf->Cell(180, 7, 'CTE Computer Programming - Unit 2 Grade Breakdown',0,0,'C');
            $pdf->Ln(10);
            ...
            $pdf->Cell(180, 7, 'This document is a breakdown of your Unit 2 standard grade.',0,0,'C');
            $pdf->Ln(10);
        ...
        //Overall Grade Breadown Table
            ...
            $pdf->Cell(36,6,$student[25],1,0,'C');
            $pdf->Ln();
            ...
            $pdf->Cell(36,7,$student[27],1,0,'C',true);
            $pdf->Ln();
            ...
            $pdf->Ln();
            $pdf->SetFont('Arial', '', 12);      
            $pdf->MultiCell(180, 7, $student[28], "LBR", 'L', false);
        ...
        //Project Breakdown Table
            ...
            $pdf->Ln();
            $pdf->SetFont('Arial', '', 12);      
            $pdf->MultiCell(180, 7, $student[21], "LBR", 'L', false);
            $pdf->Ln(15);
        ...
        //Homework Breakdown Table
            ...
            $pdf->Cell(90,6,$student[22],1,0,'C');
            ...
            $pdf->Cell(90, 7, $student[25],1,0,'C',true);
            $pdf->Ln(15);
