<?php
    ...
    $csvfile = 'unit-4-assessment-breakdown-p3.csv';
    $period = 'period3';
	...
	foreach($students as $student) {
        if($count != 0) {
            ...
            $pdf->Cell(180, 7, 'AP CSP - VCF Standard Grade Breakdown',0,0,'C');
            $pdf->Ln(10);
            ...
            $pdf->Cell(180, 7, 'This document is a breakdown of your VCF standard grade.',0,0,'C');
            $pdf->Ln(10);
            ...
            $pdf->Cell(180, 7, 'VCF Standard Overview:','B',0, 'L', false);
            $pdf->Ln();
        ...
        //Overall Grade Breadown Table
            ...
            $pdf->Cell(36,6,$student[32],1,0,'C');
            $pdf->Cell(36,6,$student[31],1,0,'C');
            $pdf->Cell(36,6,'10%',1,0,'C');
            $pdf->Cell(36,6,$student[33],1,0,'C');
            $pdf->Ln();
            ...
            $pdf->Cell(36,7,$student[34],1,0,'C',true);
            $pdf->Ln();
            $pdf->Cell(144, 7, 'Overall Unit Score',1,0,'C', true);
            $pdf->Cell(36,7,$student[35],1,0,'C',true);
            $pdf->Ln();
        ...
        //Homework Breakdown Table
            ...
            $pdf->Cell(90,6,$student[30],1,0,'C');
            $pdf->Cell(90,6,4,1,0,'C');
            $pdf->Ln();
            $pdf->SetFont('Arial', 'B',12);
            $pdf->setFillColor(160,160,160);
            $pdf->Cell(90, 7, 'Percentage',1,0,'C',true);
            $pdf->Cell(90, 7, $student[31],1,0,'C',true);
            $pdf->Ln();
            $pdf->setFillColor(61,133,198);
            $pdf->Cell(90, 7, 'SBG Score',1,0,'C',true);
            $pdf->Cell(90, 7, $student[32],1,0,'C',true);
            $pdf->Ln();
            $pdf->Cell(90, 7, 'Weighted %',1,0,'C',true);
            $pdf->Cell(90, 7, $student[33],1,0,'C',true);
            $pdf->Ln(15);
