<?php
    ...
    $csvfile = 'unit-3-java-assessment-breakdown-p2.csv';
    $period = 'period2';
	...
	foreach($students as $student) {
        if($count != 0) {
            ...
            $pdf->Cell(180, 7, 'CTE Computer Programming - Unit 3 Grade Breakdown',0,0,'C');
            $pdf->Ln(10);
            ...
            $pdf->Cell(180, 7, 'This document is a breakdown of your Unit 3 (Java) standard grade.',0,0,'C');
            $pdf->Ln(10);
