<?php
    ...
    $csvfile = 'unit-7-grade-breakdown.csv';
    $period = 'period4';
	...
	foreach($students as $student) {
        if($count != 0) {
            ...
            $pdf->Cell(180, 7, 'AP CSA - Unit 7 Standard Grade Breakdown',0,0,'C');
            $pdf->Ln(10);
