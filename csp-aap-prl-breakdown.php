<?php
	...
	foreach($students as $student) {
        if($count != 0) {
            ...
            $pdf->Cell(180, 7, 'This document is a breakdown of your AAP (PRL) standard grade.',0,0,'C');
            $pdf->Ln();
            ...
            $pdf->Cell(180, 7, 'AAP (PRL) Standard Overview:','B',0, 'L', false);
            $pdf->Ln();
            $pdf->SetFont('Arial', '', 12);
            $pdf->MultiCell(180, 7, 'This unit introduces parameters, return, and libraries. We learn how to use these concepts to build new kinds of apps as well as libraries of code that you can share with other developers.', "LBR", 'L', false);
            $pdf->Ln(10);
            ...
            $pdf->Cell(60,7,round($student[11] * 100, 0) . '%',1,0,'C',true);
            $pdf->Ln();
            $pdf->setFillColor(160,160,160);
            ...
            $pdf->Cell(60,7,round($student[13], 2),1,0,'C',true);
            $pdf->Ln(10);
            ...
            //Table Data
            $pdf->SetFont('Arial', '',12);
            $pdf->Cell(60,6,$student[39],1,0,'C');
            $pdf->Cell(60,6,round($student[40] * 100, 0) . '%',1,0,'C');
            $pdf->Cell(60,6,$student[41],1,0,'C');
            $pdf->Ln();
            $pdf->SetFont('Arial', 'B',12);
            $pdf->setFillColor(61,133,198);
            $pdf->Cell(120, 7, 'Weighted Score',1,0,'C',true);
            $pdf->Cell(60, 7, round($student[42], 2),1,0,'C',true);
            $pdf->Ln(15);
            ...
            $pdf->Cell(45,6,round($student[12], 2),1,0,'C');
            $pdf->Cell(45,6,'45%',1,0,'C');
            $pdf->Cell(45,6,round($student[13], 2),1,0,'C');
            $pdf->Ln();

            $pdf->Cell(45,6,'Homework',1,0,'C');
            $pdf->Cell(45,6,round($student[41], 2),1,0,'C');
            $pdf->Cell(45,6,'10%',1,0,'C');
            $pdf->Cell(45,6,round($student[42], 2),1,0,'C');
            $pdf->Ln();
            ...
            $pdf->Cell(45,7,$student[43],1,0,'C',true);
            $pdf->Ln();
            $pdf->setFillColor(61,133,198);
            $pdf->Cell(135, 7, 'Rounded Overall Weighted Unit Score',1,0,'C', true);
            $pdf->Cell(45,7,$student[44],1,0,'C',true);
            $pdf->Ln();
            ...
            } elseif($student[44] >= 2.5 AND $student[44] <=3.49) {
                $pdf->Cell(45,7,'B',1,0,'C',true);
            } elseif ($student[44] >= 1.5 AND $student[44] <=2.49) {
            ...
            $pdf->Ln();
            $pdf->SetFont('Arial', '', 12);      
            $pdf->MultiCell(180, 7, $student[45], "LBR", 'L', false);
            ...
            //Header
            $pdf->SetFont('Arial', 'B', 18);
            $pdf->Cell(180, 7, 'AP CSP - AAP (LLT) Standard Grade Reassessment',0,0,'C');
            $pdf->Ln(10);

            $pdf->SetFont('Arial', 'B', 12);
            $pdf->Cell(180, 7, 'Following is a breakdown of your AAP - LLT Project reassessment.',0,0,'C');
            $pdf->Ln();
            $pdf->Cell(180, 7, 'This reassessment details how your current project reflects your understanding of the ',0,0,'C');
            $pdf->Ln();
            $pdf->Cell(180, 7, 'AAP-LLT standard.  If this grade reflects a better grade than your previous assessments',0,0,'C');
            $pdf->Ln();
            ...
            $pdf->setFillColor(160,160,160);
            $pdf->Cell(120, 7, 'Percentage',1,0,'C', true);
            $pdf->Cell(60,7,round($student[19] * 100, 0) . '%',1,0,'C',true);
            $pdf->Ln();
            $pdf->setFillColor(160,160,160);
            $pdf->Cell(120, 7, 'Adjusted Score',1,0,'C', true);
            ...
            $pdf->setFillColor(61,133,198);
            $pdf->Cell(120, 7, 'Weighted Score',1,0,'C', true);
            $pdf->Cell(60,7,round($student[21], 2),1,0,'C',true);
            $pdf->Ln(10);
            ...
            $pdf->Ln();
            $pdf->SetFont('Arial', '', 12);      
            $pdf->MultiCell(180, 7, $student[22], "LBR", 'L', false);
            $pdf->Ln(15);
            ...
            $pdf->setFillColor(160,160,160);
            $pdf->Cell(120, 7, 'Percentage',1,0,'C', true);
            $pdf->Cell(60,7,round($student[27] * 100, 0) . '%',1,0,'C',true);
            $pdf->Ln();
            $pdf->setFillColor(160,160,160);
            $pdf->Cell(120, 7, 'Adjusted Score',1,0,'C', true);
            ...
            $pdf->setFillColor(61,133,198);
            $pdf->Cell(120, 7, 'Weighted Score',1,0,'C', true);
            $pdf->Cell(60,7,round($student[29], 2),1,0,'C',true);
            $pdf->Ln(10);
            ...
            $pdf->Ln();
            $pdf->SetFont('Arial', '', 12);      
            $pdf->MultiCell(180, 7, $student[30], "LBR", 'L', false);
            $pdf->Ln(15);
            ...
            $pdf->setFillColor(160,160,160);
            $pdf->Cell(120, 7, 'Average Score',1,0,'C', true);
            $pdf->Cell(60,7,$student[34],1,0,'C',true);
            $pdf->Ln();
            $pdf->setFillColor(160,160,160);
            $pdf->Cell(120, 7, 'Percentage',1,0,'C', true);
            $pdf->Cell(60,7,round($student[35] * 100, 0) . '%',1,0,'C',true);
            $pdf->Ln();
            $pdf->setFillColor(160,160,160);
            $pdf->Cell(120, 7, 'Adjusted Score',1,0,'C', true);
            ...
            $pdf->setFillColor(61,133,198);
            $pdf->Cell(120, 7, 'Weighted Score',1,0,'C', true);
            $pdf->Cell(60,7,round($student[37], 2),1,0,'C',true);
            $pdf->Ln(10);
