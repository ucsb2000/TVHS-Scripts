<?php
    ...
    $csvfile = 'unit-1-assessment-breakdown-p4.csv';
    $period = 'period4';
	...
	foreach($students as $student) {
        if($count != 0) {
            ...
            $pdf->Cell(180, 7, 'AP CSA - Unit 1 Standard Grade Breakdown',0,0,'C');
            $pdf->Ln(10);
        ...
        //Homework Breakdown Table
            ...
            $pdf->Cell(90,6,$student[17],1,0,'C');
