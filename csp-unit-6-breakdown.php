<?php
    ...
    $csvfile = 'unit-6-assessment-breakdown-p3.csv';
    $period = 'period3';
	...
	foreach($students as $student) {
        if($count != 0) {
            ...
            $pdf->Cell(180, 7, 'AP CSP - LLT Standard Grade Breakdown',0,0,'C');
            $pdf->Ln(10);
            ...
            $pdf->Cell(180, 7, 'This document is a breakdown of your LLT standard grade.',0,0,'C');
            $pdf->Ln(10);
            ...
            $pdf->Cell(180, 7, 'LLT Standard Overview:','B',0, 'L', false);
            $pdf->Ln();
        ...
        //Overall Grade Breadown Table
            ...
            $pdf->Cell(36,6,$student[39],1,0,'C');
            $pdf->Cell(36,6,$student[38],1,0,'C');
            $pdf->Cell(36,6,'10%',1,0,'C');
            $pdf->Cell(36,6,$student[40],1,0,'C');
            $pdf->Ln();
            ...
            $pdf->Cell(36,7,$student[42],1,0,'C',true);
            $pdf->Ln();
            ...
            $pdf->Ln();
            $pdf->SetFont('Arial', '', 12);      
            $pdf->MultiCell(180, 7, $student[43], "LBR", 'L', false);
