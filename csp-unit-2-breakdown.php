<?php
    ...
    $csvfile = 'unit-2-assessment-breakdown-p3.csv';
    $period = 'period3';
	...
	foreach($students as $student) {
        if($count != 0) {
            ...
            $pdf->Cell(180, 7, 'AP CSP - CSN Standard Grade Breakdown',0,0,'C');
            $pdf->Ln(10);
            ...
            $pdf->Cell(180, 7, 'This document is a breakdown of your CSN standard grade.',0,0,'C');
            $pdf->Ln(10);
            ...
            $pdf->Cell(180, 7, 'DAT Standard Overview:','B',0, 'L', false);
            $pdf->Ln();
            $pdf->SetFont('Arial', '', 12);
            $pdf->MultiCell(180, 7, 'This unit reveals how the Internet was designed to connect billions of devices and people to one another. Learn how the different protocols of the Internet work and consider the impacts the Internet has had, both good and bad, on modern life.', "LBR", 'L', false);
            $pdf->Ln(10);
        ...
        //Overall Grade Breadown Table
            ...
            $pdf->Cell(36,7,$student[20],1,0,'C',true);
            $pdf->Ln();
            $pdf->Cell(144, 7, 'Overall Unit Score',1,0,'C', true);
            $pdf->Cell(36,7,$student[21],1,0,'C',true);
            $pdf->Ln();
        ...
        //Homework Breakdown Table
            ...
            $pdf->Cell(90,6,$student[18],1,0,'C');
            $pdf->Cell(90,6,4,1,0,'C');
            $pdf->Ln();
            $pdf->SetFont('Arial', 'B',12);
            $pdf->setFillColor(160,160,160);
            $pdf->Cell(90, 7, 'Percentage',1,0,'C',true);
            $pdf->Cell(90, 7, $student[17],1,0,'C',true);
            $pdf->Ln();
            $pdf->setFillColor(61,133,198);
            $pdf->Cell(90, 7, 'SBG Score',1,0,'C',true);
            $pdf->Cell(90, 7, $student[18],1,0,'C',true);
            $pdf->Ln();
            $pdf->Cell(90, 7, 'Weighted %',1,0,'C',true);
            $pdf->Cell(90, 7, $student[19],1,0,'C',true);
            $pdf->Ln(15);
