<?php
	echo "<p>Generating CTE Computer Programming Unit 2 Quiz Rubric...</p>";

  require('fpdf185/fpdf.php');

  $csvfile = 'unit-2-quiz.csv';
  $period = 'period2';
  $points_possible = 25;
  ...
  echo "<p>";
    ...
    if($count != 0) {
      ...
      $pdf->Cell(180, 7, 'Unit 2 Quiz',0,0,'C');
      $pdf->Ln(20);
      ...
      $pdf->setFillColor(160,160,160);
      $pdf->Cell(60, 7, 'Average',1,0,'C', true);
      ...
      if (empty($student[12])) {
        $pdf->MultiCell(180, 7, 'See me if you have questions about your line item scores.', "LBR", 'L', false);
      } else {
