<?php
    ...
    $csvfile = 'unit-7-assessment-breakdown-p1.csv';
    $period = 'period1';
	...
	foreach($students as $student) {
        if($count != 0) {
            ...
            $pdf->Cell(180, 7, 'AP CSP - PRL Standard Grade Breakdown',0,0,'C');
            $pdf->Ln(10);
        ...
        //Overall Grade Breadown Table
            ...
            $pdf->Cell(36,6,$student[47],1,0,'C');
            $pdf->Cell(36,6,$student[46],1,0,'C');
            $pdf->Cell(36,6,'10%',1,0,'C');
            $pdf->Cell(36,6,$student[48],1,0,'C');
            $pdf->Ln();
            ...
            $pdf->Cell(36,6,$student[14],1,0,'C');
            $pdf->Ln();
            ...
            $pdf->Cell(36,7,$student[49],1,0,'C',true);
            $pdf->Ln();
            $pdf->Cell(144, 7, 'Overall Unit Score',1,0,'C', true);
            $pdf->Cell(36,7,$student[50],1,0,'C',true);
            $pdf->Ln();
            ...
            $pdf->Ln();
            $pdf->SetFont('Arial', '', 12);      
            $pdf->MultiCell(180, 7, $student[51], "LBR", 'L', false);
        ...
        //Homework Breakdown Table
            ...
            $pdf->Cell(90,6,$student[37],1,0,'C');
            $pdf->Cell(90,6,4,1,0,'C');
            $pdf->Ln();
            $pdf->SetFont('Arial', 'B',12);
            $pdf->setFillColor(160,160,160);
            $pdf->Cell(90, 7, 'Percentage',1,0,'C',true);
            $pdf->Cell(90, 7, $student[38],1,0,'C',true);
            $pdf->Ln();
            $pdf->setFillColor(61,133,198);
            $pdf->Cell(90, 7, 'SBG Score',1,0,'C',true);
            $pdf->Cell(90, 7, $student[39],1,0,'C',true);
            $pdf->Ln();
            $pdf->Cell(90, 7, 'Weighted %',1,0,'C',true);
            $pdf->Cell(90, 7, $student[40],1,0,'C',true);
            $pdf->Ln(15);
        
        //Generate a new page for AAP - LLT Project Reassessment Data (Unit 4)
            $pdf->AddPage();
            ...
            $pdf->setFillColor(61,133,198);
            $pdf->Cell(120, 7, 'Weighted %',1,0,'C', true);
            $pdf->Cell(60,7,$student[23],1,0,'C',true);
            $pdf->Ln(10);
            ...
            $pdf->Ln();
            $pdf->SetFont('Arial', '', 12);      
            $pdf->MultiCell(180, 7, $student[24], "LBR", 'L', false);
            $pdf->Ln(15);
        ...
        //Generate a new page for AAP - VCF Project Reassessment Data (Unit 4)
            ...
            $pdf->setFillColor(160,160,160);
            $pdf->Cell(120, 7, 'Score Average',1,0,'C', true);
            $pdf->Cell(60,7,$student[30],1,0,'C',true);
            $pdf->Ln();
            $pdf->setFillColor(160,160,160);
            $pdf->Cell(120, 7, 'Percentage',1,0,'C', true);
            ...
            $pdf->setFillColor(61,133,198);
            $pdf->Cell(120, 7, 'SBG Score',1,0,'C', true);
            $pdf->Cell(60,7,$student[32],1,0,'C',true);
            $pdf->Ln();
            $pdf->setFillColor(61,133,198);
            $pdf->Cell(120, 7, 'Weighted %',1,0,'C', true);
            ...
            $pdf->Ln();
            $pdf->SetFont('Arial', '', 12);      
            $pdf->MultiCell(180, 7, $student[34], "LBR", 'L', false);
            $pdf->Ln(15);
        ...
        //Generate a new page for AAP - CRD Project Reassessment Data (Unit 3)
            ...
            $pdf->setFillColor(160,160,160);
            $pdf->Cell(120, 7, 'Score Average',1,0,'C', true);
            $pdf->Cell(60,7,$student[40],1,0,'C',true);
            $pdf->Ln();
            $pdf->setFillColor(160,160,160);
            $pdf->Cell(120, 7, 'Percentage',1,0,'C', true);
            $pdf->Cell(60,7,$student[41],1,0,'C',true);
            $pdf->SetFont('Arial', 'B', 12);
            $pdf->Ln();
            $pdf->setFillColor(61,133,198);
            $pdf->Cell(120, 7, 'SBG Score',1,0,'C', true);
            $pdf->Cell(60,7,$student[42],1,0,'C',true);
            $pdf->Ln();
            $pdf->setFillColor(61,133,198);
            $pdf->Cell(120, 7, 'Weighted %',1,0,'C', true);
            $pdf->Cell(60,7,$student[43],1,0,'C',true);
            $pdf->Ln(10);
            ...
            $pdf->Ln();
            $pdf->SetFont('Arial', '', 12);      
            $pdf->MultiCell(180, 7, $student[44], "LBR", 'L', false);
            $pdf->Ln(15);
