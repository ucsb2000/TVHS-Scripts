<?php
	...
	foreach($students as $student) {
        if($count != 0) {
            ...
            $pdf->Cell(180, 7, 'CSN Standard Overview:','B',0, 'L', false);
            $pdf->Ln();
            $pdf->SetFont('Arial', '', 12);
            $pdf->MultiCell(180, 7, 'This unit explores how computer systems and networks work and how using multiple computers to divide tasks can speed up processes.', "LBR", 'L', false);
            $pdf->Ln(10);
