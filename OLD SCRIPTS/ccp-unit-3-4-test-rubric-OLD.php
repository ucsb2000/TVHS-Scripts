<?php
	echo "<p>Generating CTE Computer Programming Unit 3-4 Test Rubric...</p>";

  require('fpdf185/fpdf.php');

  $csvfile = 'csp-unit-4-p1.csv';
  $period = 'period5';
  $points_possible = 50;
  ...
  echo "<p>";
    ...
    if($count != 0) {
      ...
      $pdf->Cell(180, 7, 'Unit 3-4 Test Rubric (' . $points_possible . 'pts. total)',0,0,'C');
      $pdf->Ln(20);
