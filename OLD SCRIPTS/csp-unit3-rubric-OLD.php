<?php
	echo "<p>Generating Unit 3 Rubric...</p>";

  require('fpdf185/fpdf.php');

  $csvfile = 'period3-unit3.csv';
  $period = 'period3';
  ...
  echo "<p>";
    ...
    if($count != 0) {
      ...
      $percentage = ($student[8] / 40) * 100 . "%";
      
      // Header
      $pdf->SetFont('Arial', 'B', 18);
      $pdf->Cell(180, 7, 'Unit 3 Project Rubric (40 pts. total)',0,0,'C');
      $pdf->Ln(20);
