<?php
	echo "<p>Generating CTE Computer Programming Unit 5-7 Test Rubric...</p>";

  require('fpdf185/fpdf.php');

  $csvfile = 'ccp-unit-5-7-p5.csv';
  $period = 'period5';
  $points_possible = 50;
  ...
  echo "<p>";
    ...
    if($count != 0) {
      ...
      $pdf->Cell(180, 7, 'Unit 5-7 Test Rubric (' . $points_possible . 'pts. total)',0,0,'C');
      $pdf->Ln(20);
