<?php
    ...
    $csvfile = 'unit-6-assessment-breakdown-p4.csv';
    $period = 'period4';
	...
	foreach($students as $student) {
        if($count != 0) {
            ...
            $pdf->Cell(180, 7, 'AP CSA - Unit 6 Standard Grade Breakdown',0,0,'C');
            $pdf->Ln(10);
            ...
            $pdf->Cell(180, 7, 'This document is a breakdown of your Unit 6 standard grade.',0,0,'C');
            $pdf->Ln(10);
