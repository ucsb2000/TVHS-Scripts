<?php
	...
	foreach($students as $student) {
        if($count != 0) {
            ...
            $pdf->Cell(180, 7, 'AP CSP - IOC Standard Grade Breakdown',0,0,'C');
            $pdf->Ln();
            ...
            $pdf->Cell(180, 7, 'This document is a breakdown of your IOC standard grade.',0,0,'C');
            $pdf->Ln();
            ...
            $pdf->Cell(180, 7, 'IOC Standard Overview:','B',0, 'L', false);
            $pdf->Ln();
            $pdf->SetFont('Arial', '', 12);
            $pdf->MultiCell(180, 7, 'This unit examines the effects computing has had on societies, economies and cultures and consider the legal and ethical responsibilities of programmers', "LBR", 'L', false);
            $pdf->Ln(10);
