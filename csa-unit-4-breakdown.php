<?php
    ...
    $csvfile = 'unit-4-assessment-breakdown-p4.csv';
    $period = 'period4';
	...
	foreach($students as $student) {
        if($count != 0) {
            ...
            $pdf->Cell(180, 7, 'AP CSA - Unit 4 Standard Grade Breakdown',0,0,'C');
            $pdf->Ln(10);
            ...
            $pdf->Cell(180, 7, 'This document is a breakdown of your Unit 4 standard grade.',0,0,'C');
            $pdf->Ln(10);
            ...
            $pdf->Cell(180, 7, 'Unit 4 Standard Overview:','B',0, 'L', false);
            $pdf->Ln();
            $pdf->SetFont('Arial', '', 12);
            $pdf->MultiCell(180, 7, 'This unit expands on the use of APIs, object-oriented programming concepts, and conditional statements. Students learn about the functionality of the static keyword and explore the methods in the Math class to perform calculations and incorporate randomness in program decisions and behaviors. While working with conditional statements and Boolean expressions, students realize the difference between using the == operator and the equals() method to compare objects for equality and discover the need for overriding the equals() method in their own classes. They deepen their understanding of conditional statements and logical operators as they learn to write nested conditional statements, use the AND ( && ) and OR ( || ) operators, and write multi-selection statements to test multiple conditions. Using their knowledge of Boolean expressions and logical operators, they practice evaluating truth tables to compare two expressions for equivalence and applying De Morgan\'s Laws to simplify expressions.', "LBR", 'L', false);
            $pdf->Ln(10);
